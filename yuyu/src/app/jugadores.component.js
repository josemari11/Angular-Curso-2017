...
var JugadoresComponent = (function () {
    ...
    JugadoresComponent.prototype.onDelete = function (player) {
        // OBSOLETO!! BORRAR CUANDO FUNCIONE LA NUEVA VERSIÓN
    ...
    JugadoresComponent.prototype.borrar = function (jugador) {
        ...
        this.jugadorService.delete(jugador.id)
            .then(function () {
            _this.jugadores = _this.jugadores.filter(function (x) { return x !== jugador; });
    ...
    JugadoresComponent.prototype.crear = function (nombre) {
        var _this = this;
        nombre = nombre.trim(); // recorta los espacios en blanco
        if (nombre == "") {
            return;
        }
